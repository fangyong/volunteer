...
public class CopyOfModifyUserInfoAct extends Activity implements
	...
	void setProvince() {
		...
		new LoadProvinceListTask.OnTaskFinishListener() {
			...
			public void onTaskFinish(NodeList nodeList) {
				...
				listView.setAdapter(new PopupwindowListAdapter(
						CopyOfModifyUserInfoAct.this, provinceList));
		...
		}, CopyOfModifyUserInfoAct.this).execute("");
	}
	...
	public void onCitySpinerClick(View arg0) {
		if (provinceName != null) {
			...
			listView.setAdapter(new PopupwindowListAdapter(
					CopyOfModifyUserInfoAct.this, cityList));
			listView.setOnItemClickListener(new OnItemClickListener() {
	...
	public void onDistrictSpinnerClick(View arg0) {
		if (cityName != null) {
			...
			listView.setAdapter(new PopupwindowListAdapter(
					CopyOfModifyUserInfoAct.this, districtList));
			listView.setOnItemClickListener(new OnItemClickListener() {
